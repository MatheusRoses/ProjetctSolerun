...
{
    public partial class GCadastro_servico : System.Web.UI.Page
    {
        ...
        protected void btnCadastroServico_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand command = new MySqlCommand("INSERT INTO solerun_nomesservicos (Nomes,Valor,Tipo)"
                     + "VALUES ('" + txtNomeServico.Text + "','" + txtTipo.Text + "','" + txtValorServiço.Text + "')", conectar);
                conectar.Open();
