<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportAnualCliente.aspx.cs" Inherits="ProjectSolerun.Pages.reportAnualCliente" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Relatorio Anual de Clientes</title>
</head>
<body>
 ...
 <a class="navbar-brand" href="PaginaInicial.aspx">Solerun</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbcerv_solerunConnectionString %>" ProviderName="<%$ ConnectionStrings:dbcerv_solerunConnectionString.ProviderName %>" SelectCommand="SELECT Cliente,
