<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportMensalProduto.aspx.cs" Inherits="ProjectSolerun.Pages.reportMensalCliente" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Relatorio Mensal de Produtos</title>
...
<body>
 ...
 <a class="navbar-brand" href="PaginaInicial.aspx">Solerun</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    Nome Produto<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2">
        <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbcerv_solerunConnectionString %>" ProviderName="<%$ ConnectionStrings:dbcerv_solerunConnectionString.ProviderName %>" SelectCommand=" SELECT NomeProduto,
...
round((count(*) / (select count(*) from solerun_saidaproduto)*100),2) as '%'
 ...
 from solerun_saidaproduto group by NomeProduto order by ValorTotal desc;"></asp:SqlDataSource>
        </center>
    </form>
</body>
</html>
